!function () {
  var a = {
    ...
    842: function (e, t, a) {
      ...
      a.Z.constant('captchaV2Constants', n),
      t.default = n
    },
    791: function (e, t, a) {
      'use strict';
      ...
      function n(a, n, i, e) {
        ...
        r.$onInit = function () {
          ...
          !o &&
          (
            t = (e = (o = !0) === r.returnTokenInSuccessCb) ? function (e) {
              var t,
              a;
              r.activated &&
              (
                t = '',
                e.constructor === String ? a = e : (a = e.token, t = e.unifiedCaptchaId),
                a = {
                  captchaId: t,
                  captchaToken: a,
      ...
      a.Z.controller('captchaV2Controller', n),
      t.default = n
    },
    652: function (e, t, a) {
      'use strict';
      ...
      a.Z.factory('captchaV2Service', n),
      t.default = n
    },
    502: function (e, t, a) {
      'use strict';
      ...
      a.Z.factory('funCaptchaService', n),
      t.default = n
    },
    23: function (e, t, a) {
      'use strict';
      a.r(t),
      a(953).Z.value('captchaIdCounter', {
        id: 0
      })
    },
    464: function (e, t, a) {
    ...
    762: function (e, t, a) {
        ...
        n = r = !(
          i = {
            shownCb: function () {
              {
                ...
                (
                  ...
                  null !== (e = document.getElementById(w.Z.eventElementIds.shown)) &&
                  (e.value = w.Z.hybridEvents.shown, e.dispatchEvent(o)),
                  n = !0
                )
              }
            },
            successCb: function (e, t) {
              ...
              T.Hybrid.Navigation &&
              (
                null !== a ? T.Hybrid.Navigation.navigateToFeature({
              ...
              null != e &&
              (null !== a && (e.value = JSON.stringify(a)), e.dispatchEvent(o))
            },
            errorCb: S,
          ...
          triggerCaptcha: function () {
            ...
            C.Z ? (
              ...
              (
                ...
                i.returnTokenInSuccessCb = '1' === T.UrlParser.getParameterValueByName('hybrid-return-token', !1),
                null !== (
              ...
              n = setInterval(
                function () {
                  r ? (clearInterval(n), C.Z.render(w.Z.ids.appCaptcha, i)) : (new Date).getTime() - a.getTime() > w.Z.metadataLoadParameters.timeoutMilliseconds &&
                  (clearInterval(n), S())
                },
                w.Z.metadataLoadParameters.waitIntervalMilliseconds
              )
            ) : S()
          },
        ...
        (
          ...
          t = function (e) {
            for (
              ...
              var i = a[n];
              if (e <= 1000 * i.seconds) return t + i.suffix
            }
            return t + g.captchaSolveTimeLarge
          }(t = a),
          window.EventTracker &&
          window.EventTracker.fireEvent(b(d + t)),
          u = null
        ),
        A(d, e, a)
      }
      ...
      function A(e, t, a) {
        ...
        E().ajax({
          ...
          success: function () {
            window.EventTracker &&
            window.EventTracker.fireEvent(b(e + g.successSuffix)),
            O(e, a, !0),
            l &&
            (l(), E() ('#' + s).empty())
          },
          error: function () {
            window.EventTracker &&
            window.EventTracker.fireEvent(b(e + g.failSuffix)),
            O(e, a, !1),
            f &&
            f(),
            T.BootstrapWidgets &&
            T.BootstrapWidgets.ToggleSystemMessage(E() ('.alert-warning'), 100, 2000, w.Z.messages.error)
          },
          url: v[e]
        })
      }
        ...
        g = w.Z.serviceData,
        {
          ...
          render: function (e, t, a, n, i) {
            ...
            (
              ...
              window.EventTracker &&
              window.EventTracker.fireEvent(b(d + g.displayedSuffix)),
              u = x()
            )
          },
          execute: function () {
      ...
      window.Roblox.CaptchaLogger = R.Z,
      window.Roblox.FunCaptcha = C.Z,
      window.Roblox.CaptchaV2ServiceCaptchaIdBase = 0,
      window.Roblox.CaptchaConstants = w.Z,
    ...
    719: function (e, t, a) {
      ...
      t.Z = function (e) {
        ...
        r = l.Z,
        o = s().extend({
        }, r.serviceData).logConstants,
        c = !1;
        function a(e) {
          return c &&
          void 0 !== i ? ''.concat(e, '_').concat(i) : e
        }
        function n(e) {
          return e.charAt(0).toUpperCase() + e.slice(1)
        }
        this.provider = e,
        this.eventTimer = new u.Z,
    ...
    889: function (e, t, a) {
      ...
      a = function () {
        var n = [],
        a = (s().extend({
        }, u.Z.messages), new d.Z('FunCaptcha')),
        i = {},
        e = '',
        t = {};
        s().noop,
        ...
        function r(e) {
          t[e] &&
          t[e].fcInstance.refresh_session()
        }
        function o(e, t) {
          throw new Error('CAPI V1 is deprecated')
        }
        function c() {
          ...
          s() ('#redeem-card-wrapper').append(e),
          p.Dialog.close()
        }
        return {
          types: s().extend({
  ...
  function () {
    ...
    a = i(544),
    n = (i(953), i(762));
    (0, a.importFilesUnderPath) (i(37)),
    (0, a.importFilesUnderPath) (i(111)),
    (0, a.importFilesUnderPath) (i(772)),
    (0, a.importFilesUnderPath) (i(354)),
    (0, a.importFilesUnderPath) (i(5)),
    e = i(871),
    (0, a.templateCacheGenerator) (t(), 'captchaV2Templates', e),
    window.Roblox.CaptchaLogger = n.r8,
    window.Roblox.FunCaptcha = n.$3,
    window.Roblox.CaptchaConstants = n.K3,
    window.Roblox.triggerCaptcha = n.Xs,
    window.Roblox.Captcha = n.UG
  }()
}();
