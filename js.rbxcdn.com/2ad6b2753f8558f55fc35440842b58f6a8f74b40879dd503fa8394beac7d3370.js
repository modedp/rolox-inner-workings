! function() {
    ...
    function R(t) {
        ...
        "use strict";
        var t, e, n, r, o, i = HeaderScripts,
            s = {
                environments: {
                    dev: "Development",
                    prod: "Production"
                },
                metaData: (h = document.querySelector('meta[name="roblox-tracer-meta-data"]'), v = Number.isNaN(null == h || null === (t = h.dataset) || void 0 === t ? void 0 : t.sampleRate) ? 0 : parseInt(null == h || null === (v = h.dataset) || void 0 === v ? void 0 : v.sampleRate, 10), {
                    accessToken: null == h || null === (e = h.dataset) || void 0 === e ? void 0 : e.accessToken,
                    serviceName: null !== (n = null == h || null === (n = h.dataset) || void 0 === n ? void 0 : n.serviceName) && void 0 !== n ? n : "Web",
                    tracerEnabled: "true" === (null == h || null === (r = h.dataset) || void 0 === r ? void 0 : r.tracerEnabled),
                    apiSitesRequestAllowList: null !== (o = null == h || null === (o = h.dataset) || void 0 === o ? void 0 : o.apiSitesRequestAllowList) && void 0 !== o ? o : "",
                    sampleRate: v,
        ...
        var l, p = R(847),
            _ = R(279),
            f = (null === i.environmentSites || void 0 === i.environmentSites ? void 0 : i.environmentSites.isTestSite) ? s.environments.dev : s.environments.prod,
            d = {
                initTracer: function(t, e) {
                    if (!s.metaData.accessToken) return !1;
                    var n, n = new _.Tracer({
                        access_token: s.metaData.accessToken,
                        component_name: t,
                        tags: {
                            "service.version": f
                        },
                        instrument_page_load: e,
                        propagators: (n = {}, t = p.FORMAT_HTTP_HEADERS, e = new _.B3Propagator, t in n ? Object.defineProperty(n, t, {
                            value: e,
                            enumerable: !0,
                            configurable: !0,
                            writable: !0
            ...
            i = null == s || null === (T = s.metaData) || void 0 === T ? void 0 : T.sampleRate,
            T = Math.floor(100 * Math.random() + 1),
            O = (null == s || null === (l = s.metaData) || void 0 === l ? void 0 : l.tracerEnabled) && T <= i,
            E = null == s || null === (w = s.metaData) || void 0 === w ? void 0 : w.isInstrumentPagePerformanceEnabled,
            T = {
                isTracerEnabled: O,
                rootTracer: function() {
                    return O ? d.initTracer(s.metaData.serviceName, E) : null
                }
            },
            S = s.metaData.apiSitesRequestAllowList.split(","),
            i = {
                isApiSiteAvailableForTracing: function(e) {
                    return !(!c() || !c(e)) && (!!S.length && S.some(function(t) {
                        return e.includes(t)
                    }))
                }
            },
        ...
        T.rootTracer(), window.RobloxTracer = {
            ...
            inject: v,
            extract: b,
            apiSiteRequestValidator: i,
            tracerConstants: w
        }
    }()
}();
//# sourceMappingURL=https://js.rbxcdn.com/afc1cc28c1af42ca91be-robloxTracer.bundle.min.js.map
