! function() {
    ...
    function R() {
        ...
        function t(e) {
            var t = e.translate,
                ...
                e = be().createElement("div", {
                    ...
                    dangerouslySetInnerHTML: {
                        __html: t(E.insufficientFundsMessage, {
            ...
            return r || (e = be().createElement("div", null, " ", t(E.additionalRobuxNeeded))), be().createElement(i, v({
                title: t(E.insufficientFundsHeading),
                body: e,
                thumbnail: be().createElement("span", {
                    className: "money-stack-icon"
                }),
                neutralButtonText: t(E.cancelAction),
                actionButtonText: t(E.buyRobuxAction),
                onAction: function() {
                    return P.paymentFlowAnalyticsService.sendUserPurchaseFlowEvent(P.paymentFlowAnalyticsService.ENUM_TRIGGERING_CONTEXT.WEB_CATALOG_ROBUX_UPSELL, !0, P.paymentFlowAnalyticsService.ENUM_VIEW_NAME.ROBUX_UPSELL, P.paymentFlowAnalyticsService.ENUM_PURCHASE_EVENT_TYPE.USER_INPUT, P.paymentFlowAnalyticsService.ENUM_VIEW_MESSAGE.BUY_ROBUX), a ? a() : window.location = x.getRobuxUpgradesUrl(n), !1
                },
                onClose: function() {
    ...
    function N(e) {
        ...
        return e ? be().createElement("span", {
            dangerouslySetInnerHTML: {
                __html: t(M.balanceAfterMessage, {
    ...
    var C = (0, o.withTranslations)(N, s.purchasingResources);
    ...
    var X = x.getAvatarPageUrl,
        $ = a.resources;

    function ve() {
        var e = W((0, T.createModal)(), 2),
            h = e[0],
            e = e[1];
        ...
        function t(e) {
            ...
            return be().createElement(h, {
                ...
                onAction: p || r,
                onNeutral: f,
                footerText: !m && be().createElement(C, {
                    expectedPrice: a,
    ...
    var Y = x.getPurchaseItemUrl,
        Q = x.getPurchaseCollectibleItemUrl,
        K = x.getPurchaseCollectibleItemInstanceUrl,
        J = x.postBulkPurchaseUrl,
        Z = x.postPurchaseDeveloperProductUrl,
        Se = {
        ...
        ee = x.getItemDetailsUrl,
        te = (x.postItemDetailsUrl, x.getPurchaseableDetailUrl),
        re = x.getResellerDataUrl,
        ne = x.getMetaDataUrl,
        ae = (x.getCollectibleItemDetailsUrl, x.getCurrentUserBalance),
        ie = function(e, t) {
            t = {
                url: ee(e, t),
                retryable: !0,
        ...
        de = x.getTwoStepVerificationConfig,
        me = x.postGenerateTwoStepVerificationToken,
        pe = x.postRedeemTwoStepVerificationChallenge,
        Ie = function() {
    ...
    function _e() {
        ...
        var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
            ...
            e = De((0, T.createSystemFeedback)(), 2),
            Z = e[0],
            ee = e[1],
            e = De((0, T.createSystemFeedback)(), 2),
            te = e[0],
        ...
        function t(e) {
            ...
            var l = e.translate,
                ...
                I = e.collectibleItemInstanceId,
                E = e.collectibleProductId,
                w = e.isLimited,
                a = e.customProps,
                A = e.saleLocationId,
                R = void 0 === A ? null : A,
                            ...
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    if (n = {
                                        ...
                                        }, I && (n.collectibleItemInstanceId = I), E && (n.collectibleProductId = E), v) return v({
                                        params: n,
                                        handleError: G,
                                        setLoading: M,
                                        openConfirmation: W,
                                    ...
                                    break;
                                case 6:
                                    return M(!0), o = I ? Se.purchaseCollectibleItemInstance : Se.purchaseCollectibleItem, t.prev = 8, t.next = 11, o(P, n);
                                case 11:
                                ...
                                case 26:
                                    ...
                                    break;
                                case 28:
                                    if (t.prev = 28, t.t0 = t.catch(8), console.debug(t.t0), ge.AccountIntegrityChallengeService.Generic.ChallengeError.matchAbandoned(C)) return M(!1), t.abrupt("return");
                                    t.next = 34;
                                    break;
                                case 34:
    ...
    function Ze(e) {
        ...
        if (p) return be().createElement(T.Loading, null);
        if (!y) return null != b ? be().createElement(T.Button, {
            id: "upgrade-button",
        ...
        }, t(Ke.getPremiumAction)) : be().createElement(T.Button, {
        ...
        return d && (u || 0 === n) ? be().createElement(be().Fragment, null, be().createElement(T.Button, {
            className: "btn-fixed-width-lg btn-primary-lg InstallButton",
            onClick: function() {
                var e;
                e = m, ge.GameLauncher.openPluginInStudio(e)
            }
        }, be().createElement("span", null, t(Ke.installAction)))) : be().createElement(be().Fragment, null, be().createElement(T.Button, {
            className: "btn-fixed-width-lg btn-growth-lg PurchaseButton",
            onClick: Qe.start,
            isDisabled: !g
    ...
    function st(e) {
        ...
        var r = e.translate,
            ...
            S = !0,
            e = "";
        return u ? be().createElement(T.Loading, null) : (!u && d ? e = it.retryErrorMessage : y === at.offSale && null === g ? e = r(at.itemNoLongerForSaleLabel) : h || l ? f || !l || p ? p && 0 === m && !b ? e = r(at.noOneCurrentlySellingLabel) : S = !1 : e = r(at.itemAvailableInventoryLabel) : e = r(at.purchasingTemporarilyUnavailableLabel), 0 === n ? null : S && !l ? be().createElement("div", {
    ...
    (Ct = dr = dr || {}).Success = "Success", Ct.AlreadyOwned = "ALREADY_OWNED", Ct.InsufficientFunds = "INSUFFICIENT_ROBUX", Ct.ExceptionOccured = "INTERNAL", Ct.TooManyPurchases = "QUOTA_EXCEEDED", Ct.CaughtError = "CaughtError", Ct.PremiumNeeded = "INSUFFICIENT_MEMBERSHIP", Ct.NoSellers = "NOT_FOR_SALE", Ct.TwoStepVerificationRequired = "TwoStepVerificationRequired", Ct.InExperienceOnly = "PURCHASE_PLACE_INVALID";
    var Vt = dr;
    ...
    function Jt(e) {
        ...
        return be().createElement("div", {
            ...
            type: r.itemType.toLowerCase() === Ft.Bundle ? ze.ThumbnailTypes.bundleThumbnail : ze.ThumbnailTypes.assetThumbnail,
            size: ze.DefaultThumbnailSize,
            targetId: r.id,
    ...
    var rr = a.resources,
        nr = x.getVngBuyRobuxBehaviorUrl,
        ar = function() {
            var e = {
                url: nr(),
                retryable: !0,
    ...
    var sr, cr = a.resources,
        lr = (Ct = ir(R(), 2))[0],
        ur = Ct[1],
        dr = ir((sr = (Nt = zt((0, T.createModal)(), 2))[0], Nt = Nt[1], fr.defaultProps = {
            title: "",
            loading: !1
        }, fr.propTypes = {
            translate: r().func.isRequired,
    ...
    function fr(e) {
        ...
        function E() {
            return (E = Wt(regeneratorRuntime.mark(function e() {
                var t, r, n, a, i, o, s, c;
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                        ...
                        case 16:
                            e.prev = 16, e.t0 = e.catch(8), o = e.t0, c = 0, n.forEach(function(e) {
                                n[c].data.reason = o.data.message, c += 1
                            });
                        case 21:
                            I(o), d(n);
                        case 23:
    ...
    var br, yr = (Ct = ir((br = (Nt = er((0, T.createModal)(), 2))[0], Nt = Nt[1], hr.defaultProps = {
    ...
    function vr(e) {
        var t = e.currentUserBalance,
            ...
            b = 0,
            y = [],
            g = ir((0, fe.useState)(!1), 2),
            h = g[0],
            v = g[1],
            S = ir((0, fe.useState)(!1), 2),
            P = S[0],
            I = S[1],
            e = ir((0, fe.useState)(null), 2),
            g = e[0],
            E = e[1],
            S = ir((0, fe.useState)(null), 2),
            e = S[0],
            w = S[1];
        (0, fe.useEffect)(function() {
            ar().then(function(e) {
        ...
        if (void 0 === n || 0 < n.length && n[0] && n[0].loading || void 0 === t) return be().createElement("div", {
            ...
            size: T.Button.sizes.large,
            isDisabled: !0
        }, be().createElement(T.Loading, null)));
        if (0 === n.length || n[0] && n[0].loadFailure) return be().createElement(T.Button, {
            className: "action-button batch-buy-purchase-button",
            variant: T.Button.variants.growth,
            size: T.Button.sizes.large,
            isDisabled: !0
        ...
        var R = function() {
            P ? gr.open() : window.location = x.getRobuxUpgradesUrl("")
        };
        return be().createElement(be().Fragment, null, be().createElement("div", null, be().createElement(T.Button, {
            className: "action-button batch-buy-purchase-button",
            variant: T.Button.variants.growth,
            size: T.Button.sizes.large,
            onClick: function() {
                var e;
                0 < A ? (w(be().createElement(lr, {
                    robuxNeeded: A,
                    onAccept: R
                })), ur.open()) : (e = be().createElement(mr, {
                    title: m(cr.buyNowAction),
                    expectedTotalPrice: f + b,
                    items: r,
                    purchaseMetadata: a,
                    itemDetails: n,
                    resaleItems: y,
                    ...
                    onAction: function() {
                        var e;
                        null == pr || null !== (e = pr.close) && void 0 !== e && e.call(pr), v(!0), o()
                    },
                    loading: !1,
                    productSurface: l,
            ...
            isDisabled: !p
        }, S)), 0 < A && be().createElement("div", {
            id: "insufficient-funds-modal"
        }, e), P && be().createElement("div", {
            ...
            onContinueToPayment: function() {
                ...
                ye.httpService.get(e).then(function(e) {
                    ...
                    window.open(x.getVngShopFallbackUrl, "_blank").focus()
                }), gr.close()
            }
    ...
    Er.propTypes = {
    ...
    }, dr = (0, o.withTranslations)(Er, s.purchasingResources), Ct = a.errorTypeIds, window.RobloxItemPurchase = {
        ...
        e && (0, t.render)(be().createElement(Et, null), e)
    })
}();
//# sourceMappingURL=https://js.rbxcdn.com/e1567147056cab6827ba9df44054d919-itemPurchase.bundle.min.js.map
